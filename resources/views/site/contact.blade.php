...
@section('content')
    ...
    <!-- Contact Start -->
    @if(session()->has('msg'))
    <div class="alert alert-{{ session('type') }} alert-dismissible fade show container col-md-4" role="alert">
        {{ session('msg') }}
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="wow fadeIn" data-wow-delay="0.3s">
                        <form action="{{ route('site.contact.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
