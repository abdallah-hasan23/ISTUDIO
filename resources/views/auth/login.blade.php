...
<html lang="en">
  ...
  <head>
    ...
    <title>ISTUDIO | Login Page</title>
    ...
    <meta name="title" content="ISTUDIO | Login Page" />
    <meta name="author" content="ISTUDIO" />
    <meta
      name="description"
      content="ISTUDIO Admin Dashboard Login"
    />
        ...
        <div class="card-body login-card-body">
          ...
          <form method="POST" action="{{ route('login') }}">
            ...
            <div class="input-group mb-3">
              <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" />
