...
@if ($about)
    ...
    <div class="card p-3">
        ...
        <p><strong>Experience:</strong> {{ $about->experience_years }} years</p>
        <p><strong>Projects Count:</strong> {{ $about->projects_count }}</p>
        <p><strong>Team Count:</strong> {{ $about->team_count }}</p>
